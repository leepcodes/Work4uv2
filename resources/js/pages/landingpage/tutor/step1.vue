    ...
    <div class="min-h-screen bg-white font-inter">
        ...
        <nav class="w-full bg-white px-10 py-4 flex items-center justify-between">
            ...
            <Link 
                ...
                method="post" 
                as="button"
                class="text-black text-sm hover:text-gray-800 transition-colors font-bold tracking-widest"
            >
                LOGOUT
            </Link>
        </nav>
        ...
        <div class="flex px-10 py-10">
            ...
            <div class="flex flex-col items-center gap-0 pt-2 shrink-0">
                <div class="w-9 h-9 rounded-full bg-[#007582] text-sm flex items-center justify-center shadow-md">
                    1
                </div>
