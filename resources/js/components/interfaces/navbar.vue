        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <Link 
                        href="/dashboard" 
                        class="text-gray-900 font-medium pb-1 border-b-2 border-blue-600 hover:text-blue-600 transition-colors"
                    >
                        Dashboard
                    </Link>
                    <Link 
                        href="/cars" 
                        class="text-gray-500 font-medium pb-1 border-b-2 border-transparent hover:text-gray-900 hover:border-gray-300 transition-colors"
                    >
                        Tutoring
                    </Link>
                    <Link 
