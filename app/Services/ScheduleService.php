...
class ScheduleService
{
    ...
    public function getPackageClasses(string $uuid): array
    {
        ...
        $classes = Classes::where('schedule_id', $schedule->id)
    ...
    {
        $schedule = Schedule::with(['subject', 'tutor'])
            ->where('user_id', auth()->id())
            ->where('uuid', $uuid)
            ->firstOrFail();
    ...
    public function getStudentClassDetails(string $uuid, string $classUuid): array
{
